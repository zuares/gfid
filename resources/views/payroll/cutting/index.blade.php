...
@section('content')
    <div class="page-wrap">
        ...
        <div class="d-flex justify-content-between align-items-start mb-3">
            <div>
                <h1 class="h5 mb-1">Payroll Cutting</h1>
                <p class="help-text mb-0">
                    Rekap borongan cutting per periode. Gunakan tombol <strong>Generate</strong> untuk membuat periode baru.
                </p>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('payroll.cutting.create') }}" class="btn btn-primary btn-sm">
                        ...
                        <tbody>
                            @forelse ($periods as $period)
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('payroll.cutting.show', $period) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-4">
                                        Belum ada periode payroll cutting.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
